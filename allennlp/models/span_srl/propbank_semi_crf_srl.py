...
@Model.register("propbank_semi_crf_srl")
class PropBankSemiCrfSrl(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        super(PropBankSemiCrfSrl, self).__init__(vocab, regularizer)
        ...
        # TODO(Swabha): find out for OntoNotes.
    ...
    def forward(self,  # type: ignore
        ...
        # Concatenate the verb feature onto the embedded text.
        # This now has shape (batch_size, sequence_length, embedding_dim + binary_feature_dim).
