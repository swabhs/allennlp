...
class ChunkyElmoIndexer(TokenIndexer[List[int]]):
    ...
    def __init__(self,
        ...
        # First get the chunk tags.
        if preprocessed_chunk_file is None:
    ...
    def tokens_to_indices(self,
        ...
        chunk_tags_seglm_ids = [self.seglm_vocab.get_token_index(t, "labels") for t in chunk_tags_str]
...
if __name__== "__main__":
    ...
    self = ChunkyElmoIndexer(chunker_path="/Users/swabhas/pretrained/log_chunking_ptb_comparable/model.tar.gz",
